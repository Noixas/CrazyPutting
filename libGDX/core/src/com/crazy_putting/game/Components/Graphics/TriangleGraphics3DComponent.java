...
public class TriangleGraphics3DComponent extends Graphics3DComponent {

    private Vector3 _from;
    private  Vector3 _to;
    public TriangleGraphics3DComponent(Vector3 from, Vector3 to){
        _from = from;
        _to = to;

        initArrow();
    }
    public TriangleGraphics3DComponent(Vector3 from, Vector3 to, Color pColor){
        _color = pColor;
        _from = from;
        _to = to;
        initArrow();
    }
    private void initArrow(){//TODO: This is arrow implementation, testing only
