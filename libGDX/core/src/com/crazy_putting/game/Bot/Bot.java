...
public class Bot extends SuperBot{
    ...
    public Bot(Ball ball, Hole hole, Course course, Vector3 initial_position){
        ...
        int startX = Math.round(CourseManager.getStartPosition().x);
        int startY = Math.round(CourseManager.getStartPosition().y);
        int goalX = Math.round(CourseManager.getGoalStartPosition().x);
        int goalY = Math.round(CourseManager.getGoalStartPosition().y);
